...
public class FastInfoFrame{
    FastInfoFrame(){
        JFrame finfoframe = new JFrame("Fast Mode Info");
        finfoframe.setSize(1200, 650);
        finfoframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ImageIcon logo = new ImageIcon("logo.png");
        finfoframe.setIconImage(logo.getImage());
        finfoframe.setResizable(false);
        
        JPanel panel = new JPanel();
        panel.setBackground(Color.BLACK);
        panel.setLayout(null);
        
        JLabel ins1 = new JLabel("Fast mode is a mode of Snake game where the speed of the game is increased drastically.");
        ...
        finfoframe.add(panel);
        finfoframe.setVisible(true);
        finfoframe.setLocationRelativeTo(null);
    }
