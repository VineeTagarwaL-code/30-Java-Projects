...
public class ClassicInfoFrame{
    ClassicInfoFrame(){
        JFrame cinfoframe = new JFrame("Classic Mode Info");
        cinfoframe.setSize(1200, 650);
        cinfoframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ImageIcon logo = new ImageIcon("logo.png");
        cinfoframe.setIconImage(logo.getImage());
        cinfoframe.setResizable(false);
        
        JPanel panel = new JPanel();
        panel.setBackground(Color.BLACK);
        panel.setLayout(null);
        
        JLabel ins1 = new JLabel("Classic mode is the normal mode of Snake game.");
        ...
        cinfoframe.add(panel);
        cinfoframe.setVisible(true);
        cinfoframe.setLocationRelativeTo(null);
    }
    public static void main(String[] args) {
        new ClassicInfoFrame();
    }
}