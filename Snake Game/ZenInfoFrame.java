...
public class ZenInfoFrame{
    ZenInfoFrame(){
        JFrame zinfoframe = new JFrame("Zen Mode Info");
        zinfoframe.setSize(1200, 650);
        zinfoframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ImageIcon logo = new ImageIcon("logo.png");
        zinfoframe.setIconImage(logo.getImage());
        zinfoframe.setResizable(false);
        
        JPanel panel = new JPanel();
        panel.setBackground(Color.BLACK);
        panel.setLayout(null);
        
        JLabel ins1 = new JLabel("Zen mode is a mode of Snake game where the snake doesn't die on collision with a wall.");
        ins1.setForeground(Color.WHITE);
        ins1.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
        ...
        JLabel ins4 = new JLabel("The snake will die only if it runs into itself.");
        ...
        zinfoframe.add(panel);
        zinfoframe.setVisible(true);
        zinfoframe.setLocationRelativeTo(null);
    }
